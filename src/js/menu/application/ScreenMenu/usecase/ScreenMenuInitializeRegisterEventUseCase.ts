...
export const execute = (): void =>
{
    ...
    // キーフレームに分散ボタンのイベントを登録
    const distributeToKeyframeElement: HTMLElement | null = document
        .getElementById($SCREEN_DISTRIBUTE_TO_KEYFRAMES_ID);

    if (distributeToKeyframeElement) {
