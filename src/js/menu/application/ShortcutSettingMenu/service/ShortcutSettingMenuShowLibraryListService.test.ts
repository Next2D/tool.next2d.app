import { execute } from "./ShortcutSettingMenuShowLibraryListService";
import {
...
describe("ShortcutSettingMenuShowLibraryListServiceTest", () =>
{
    test("execute test", () =>
    {
        ...
        expect(timelineList.classList.contains("shortcut-inactive")).toBe(true);
        expect(libraryList.classList.contains("shortcut-inactive")).toBe(false);
        expect(screenSetting.classList.contains("shortcut-active")).toBe(false);
        expect(timelineSetting.classList.contains("shortcut-active")).toBe(false);
        expect(librarySetting.classList.contains("shortcut-active")).toBe(true);
