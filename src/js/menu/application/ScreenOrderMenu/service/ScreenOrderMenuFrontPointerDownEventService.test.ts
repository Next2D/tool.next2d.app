import { execute } from "./ScreenOrderMenuFrontPointerDownEventService";
...
describe("ScreenOrderMenuFrontPointerDownEventService", () =>
{
    ...
    it("should execute successfully and move character to frontmost position", async () =>
    {
        ...
        expect(mockLayer.getActiveCharacters).toHaveBeenCalledWith(0);
        ...
        expect(mockExternalCharacter.changeDepth).toHaveBeenCalledWith(2);
    });
    ...
    it("should return early if character is not found", async () =>
    {
        ...
        expect(mockLayer.getActiveCharacters).not.toHaveBeenCalled();
        expect(mockExternalCharacter.changeDepth).not.toHaveBeenCalled();
    });

    it("should return early if depth is 0 or less", async () =>
    {
        ...
        expect($allHideMenu).toHaveBeenCalled();
        expect(mockEvent.stopPropagation).toHaveBeenCalled();
        expect(mockLayer.getActiveCharacters).toHaveBeenCalled();
