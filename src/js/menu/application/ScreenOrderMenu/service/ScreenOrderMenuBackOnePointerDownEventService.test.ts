import { execute } from "./ScreenOrderMenuBackOnePointerDownEventService";
...
describe("ScreenOrderMenuBackOnePointerDownEventService", () =>
{
    ...
    it("should execute successfully and move character back by one depth", async () =>
    {
        ...
        expect(mockExternalCharacter.changeDepth).toHaveBeenCalledWith(4);
    });
