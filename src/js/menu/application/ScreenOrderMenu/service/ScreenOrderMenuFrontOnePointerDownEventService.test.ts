import { execute } from "./ScreenOrderMenuFrontOnePointerDownEventService";
...
describe("ScreenOrderMenuFrontOnePointerDownEventService", () =>
{
    ...
    it("should execute successfully and move character forward by one depth", async () =>
    {
        ...
        expect(mockExternalCharacter.changeDepth).toHaveBeenCalledWith(6);
    });
