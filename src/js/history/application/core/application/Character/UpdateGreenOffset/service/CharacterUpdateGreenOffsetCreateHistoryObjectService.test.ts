import { execute } from "./CharacterUpdateGreenOffsetCreateHistoryObjectService";
import { $CHARACTER_UPDATE_GREEN_OFFSET_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { Character } from "../../../../../../../core/domain/model/Character";
import { describe, expect, it } from "vitest";

describe("CharacterUpdateGreenOffsetCreateHistoryObjectService Test", () =>
{
    it("execute test", () =>
    {
        ...
        expect(object.command).toBe($CHARACTER_UPDATE_GREEN_OFFSET_COMMAND);
