import { execute } from "./CharacterUpdateScaleYCreateHistoryObjectService";
import { $CHARACTER_UPDATE_SCALE_Y_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { Character } from "../../../../../../../core/domain/model/Character";
import { describe, expect, it } from "vitest";

describe("CharacterUpdateScaleYCreateHistoryObjectService Test", () =>
{
    it("execute test", () =>
    {
        ...
        expect(object.command).toBe($CHARACTER_UPDATE_SCALE_Y_COMMAND);
        ...
        expect(object.messages[6]).toBe(character.scaleY * 100);
        ...
        expect(object.args[5]).toBe(character.scaleY * 100);
    });
});