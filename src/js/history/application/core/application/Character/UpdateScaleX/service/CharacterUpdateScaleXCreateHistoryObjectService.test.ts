import { execute } from "./CharacterUpdateScaleXCreateHistoryObjectService";
import { $CHARACTER_UPDATE_SCALE_X_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { Character } from "../../../../../../../core/domain/model/Character";
import { describe, expect, it } from "vitest";

describe("CharacterUpdateScaleXCreateHistoryObjectService Test", () =>
{
    it("execute test", () =>
    {
        ...
        expect(object.command).toBe($CHARACTER_UPDATE_SCALE_X_COMMAND);
