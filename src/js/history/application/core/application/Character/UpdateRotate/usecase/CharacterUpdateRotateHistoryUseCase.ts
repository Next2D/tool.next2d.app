...
import { execute as characterUpdateRotateCreateHistoryObjectService } from "../service/CharacterUpdateRotateCreateHistoryObjectService";
...
export const execute = async (
    ...
    if (work_space.active) {
        historyAddElementUseCase(
            ...
            historyGetTextService($CHARACTER_UPDATE_ROTATE_COMMAND),
            "",
            ...historyObject.args
        );
    }
