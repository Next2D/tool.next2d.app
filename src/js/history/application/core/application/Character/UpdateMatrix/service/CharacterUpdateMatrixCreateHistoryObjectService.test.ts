import { execute } from "./CharacterUpdateMatrixCreateHistoryObjectService";
import { $CHARACTER_UPDATE_MATRIX_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { Character } from "../../../../../../../core/domain/model/Character";
import { describe, expect, it } from "vitest";

describe("CharacterUpdateMatrixCreateHistoryObjectService Test", () =>
{
    it("execute test", () =>
    {
        ...
        const object = execute(1, movieClip, layer, character, [2,0,0,1.2,100,200]);
        expect(object.command).toBe($CHARACTER_UPDATE_MATRIX_COMMAND);
        ...
        expect(object.messages[5].toString()).toBe("2,0,0,1.2,100,200");
        expect(object.messages[6].toString()).toBe("1,0,0,1,0,0");
        ...
        expect(object.args[4]).toBe("[2,0,0,1.2,100,200]");
        expect(object.args[5]).toBe("[1,0,0,1,0,0]");
    });
});