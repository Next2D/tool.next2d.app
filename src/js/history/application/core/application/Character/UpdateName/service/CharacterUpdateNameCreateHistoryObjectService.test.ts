import { execute } from "./CharacterUpdateNameCreateHistoryObjectService";
import { $CHARACTER_UPDATE_NAME_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { Character } from "../../../../../../../core/domain/model/Character";
import { describe, expect, it } from "vitest";

describe("CharacterUpdateNameCreateHistoryObjectService Test", () =>
{
    it("execute test", () =>
    {
        ...
        const object = execute(1, movieClip, layer, character, "test_character");
        expect(object.command).toBe($CHARACTER_UPDATE_NAME_COMMAND);
        ...
        expect(object.messages[5]).toBe("test_character");
        expect(object.messages[6]).toBe(character.name);
