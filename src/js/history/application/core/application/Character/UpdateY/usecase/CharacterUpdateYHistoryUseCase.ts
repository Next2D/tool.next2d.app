...
/**
 * @description DisplayObjectのy座標履歴の更新
 *              Update y-coordinate history of DisplayObject
 *
...
export const execute = (
    ...
    // fixed logic
    const historyObject = characterUpdateYCreateHistoryObjectService(
        work_space.id, movie_clip, layer, character, before_y
    );
