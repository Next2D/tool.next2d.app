import { execute } from "./CharacterUpdateBlueMultiplierCreateHistoryObjectService";
import { $CHARACTER_UPDATE_BLUE_MULTIPLIER_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { Character } from "../../../../../../../core/domain/model/Character";
import { describe, expect, it } from "vitest";

describe("CharacterUpdateBlueMultiplierCreateHistoryObjectService Test", () =>
{
    it("execute test", () =>
    {
        ...
        expect(object.command).toBe($CHARACTER_UPDATE_BLUE_MULTIPLIER_COMMAND);
