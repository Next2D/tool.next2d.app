import { execute } from "./CharacterUpdateBlendModeCreateHistoryObjectService";
import { $CHARACTER_UPDATE_BLEND_MODE_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { Character } from "../../../../../../../core/domain/model/Character";
import { describe, expect, it } from "vitest";

describe("CharacterUpdateBlendModeCreateHistoryObjectService Test", () =>
{
    it("execute test", () =>
    {
        ...
        const object = execute(1, movieClip, layer, character, "add");
        expect(object.command).toBe($CHARACTER_UPDATE_BLEND_MODE_COMMAND);
        ...
        expect(object.messages[5]).toBe("normal");
        expect(object.messages[6]).toBe("add");
        ...
        expect(object.args[4]).toBe("normal");
        expect(object.args[5]).toBe("add");
    });
});