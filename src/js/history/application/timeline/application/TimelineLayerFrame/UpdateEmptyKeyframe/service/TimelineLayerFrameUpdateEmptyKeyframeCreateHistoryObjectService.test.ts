import { execute } from "./TimelineLayerFrameUpdateEmptyKeyframeCreateHistoryObjectService";
import { $TIMELINE_UPDATE_EMPTY_KEYFRAME_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { EmptyCharacter } from "../../../../../../../core/domain/model/EmptyCharacter";
import { describe, expect, it } from "vitest";

describe("TimelineLayerFrameUpdateEmptyKeyframeCreateHistoryObjectServiceTest", () =>
{
    it("execute test", () =>
    {
        ...
        const object = execute(1, movieClip, layer, emptyCharacter, 2);
        expect(object.command).toBe($TIMELINE_UPDATE_EMPTY_KEYFRAME_COMMAND);
