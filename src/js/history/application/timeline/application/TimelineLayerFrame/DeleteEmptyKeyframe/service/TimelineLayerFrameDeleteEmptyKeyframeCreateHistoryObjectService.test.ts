import { execute } from "./TimelineLayerFrameDeleteEmptyKeyframeCreateHistoryObjectService";
...
describe("TimelineLayerFrameRemoveEmptyFramesCreateHistoryObjectServiceTest", () =>
{
    it("execute test", () =>
    {
        ...
        const object = execute(1, movieClip, layer, emptyCharacter);
        expect(object.command).toBe($TIMELINE_DELETE_EMPTY_KEY_FRAME_COMMAND);
        ...
        expect(object.messages[4].startFrame).toBe(emptyCharacter.startFrame);
        expect(object.messages[4].endFrame).toBe(emptyCharacter.endFrame);
