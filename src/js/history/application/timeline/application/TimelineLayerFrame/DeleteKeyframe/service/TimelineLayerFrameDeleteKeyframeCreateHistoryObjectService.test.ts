import { execute } from "./TimelineLayerFrameDeleteKeyframeCreateHistoryObjectService";
import { $TIMELINE_DELETE_KEY_FRAME_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { Character } from "../../../../../../../core/domain/model/Character";

describe("TimelineLayerFrameDeleteKeyframeCreateHistoryObjectServiceTest", () =>
{
    test("execute test", () =>
    {
        ...
        expect(object.command).toBe($TIMELINE_DELETE_KEY_FRAME_COMMAND);
