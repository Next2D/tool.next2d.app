import { execute } from "./TimelineLayerFrameUpdateKeyframeCreateHistoryObjectService";
import { $TIMELINE_UPDATE_KEYFRAME_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { EmptyCharacter } from "../../../../../../../core/domain/model/EmptyCharacter";
import { describe, expect, it } from "vitest";

describe("TimelineLayerFrameUpdateKeyframeCreateHistoryObjectServiceTest", () =>
{
    it("execute test", () =>
    {
        ...
        const object = execute(1, movieClip, layer, 1, 2, 10);
        expect(object.command).toBe($TIMELINE_UPDATE_KEYFRAME_COMMAND);
        ...
        expect(object.args[3]).toBe(10 - 2);
    });
});