...
import { execute as timelineLayerFrameSplitEmptyKeyframeCreateHistoryObjectService } from "../service/TimelineLayerFrameSplitEmptyKeyframeCreateHistoryObjectService";
...
/**
 * @description 空のキーフレームの分割履歴を登録
 *              Register the history of dividing an empty keyframe
 *
...
export const execute = (
    ...
    const historyObject = timelineLayerFrameSplitEmptyKeyframeCreateHistoryObjectService(
        ...
        empty_character, new_empty_character
    );
    ...
    if (work_space.active) {
        historyAddElementUseCase(
            ...
            historyGetTextService($TIMELINE_SPLIT_EMPTY_KEYFRAME_COMMAND),
            "",
            ...historyObject.args
        );
    }
