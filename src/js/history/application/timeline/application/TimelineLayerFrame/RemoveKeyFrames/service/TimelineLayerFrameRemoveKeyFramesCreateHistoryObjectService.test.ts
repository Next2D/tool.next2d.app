import { execute } from "./TimelineLayerFrameRemoveKeyFramesCreateHistoryObjectService";
...
describe("TimelineLayerFrameRemoveEmptyFramesCreateHistoryObjectServiceTest", () =>
{
    it("execute test", () =>
    {
        ...
        const object = execute(1, movieClip, layer, 1, 15, 10);
        expect(object.command).toBe($TIMELINE_REMOVE_KEY_FRAMES_COMMAND);
