...
import { execute as timelineLayerFrameInsertEmptyFramesCreateHistoryObjectService } from "../service/TimelineLayerFrameInsertEmptyFramesCreateHistoryObjectService";
...
export const execute = async (
    ...
    // fixed logic
    const historyObject = timelineLayerFrameInsertEmptyFramesCreateHistoryObjectService(
        work_space.id, movie_clip, layer,
        empty_character, num_frame
    );
    ...
    if (work_space.active) {
        historyAddElementUseCase(
            ...
            historyGetTextService($TIMELINE_INSERT_EMPTY_FRAME_COMMAND),
            "",
            ...historyObject.args
        );
    }
