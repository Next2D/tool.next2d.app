...
describe("TimelineToolLayerDeleteCreateHistoryObjectServiceTest", () =>
{
    it("execute test", () =>
    {
        ...
        const object = execute(1, movieClip, 9, [1,5], layer);
        ...
        expect(object.messages[3][0]).toBe(1);
        expect(object.messages[3][1]).toBe(5);
        expect(object.messages[4].name).toBe(layer.name);
