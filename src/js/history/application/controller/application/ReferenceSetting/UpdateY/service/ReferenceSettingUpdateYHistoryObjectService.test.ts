...
describe("ReferenceSettingUpdateYHistoryObjectService Test", () =>
{
    it("execute test", () =>
    {
        ...
        expect(object.messages[6]).toBe(character.referencePosition.getLocalPosition().y);
        expect(object.messages[7]).toBe(200);
        expect(object.messages[8]).toBe(character.referencePosition.pivot);
        expect(object.messages[9]).toBe(character.referencePosition.getLocalPosition().x);
        ...
        expect(object.args[4]).toBe(character.referencePosition.getLocalPosition().y);
