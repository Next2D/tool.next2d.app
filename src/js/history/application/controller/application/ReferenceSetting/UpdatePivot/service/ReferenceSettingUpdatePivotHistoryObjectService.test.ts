...
describe("ReferenceSettingUpdatePivotHistoryObjectService Test", () =>
{
    it("execute test", () =>
    {
        ...
        const object = execute(1, movieClip, layer, character, "middle-center", "top-left");
        ...
        expect(object.messages[6].toString()).toBe("middle-center");
        expect(object.messages[7].toString()).toBe("top-left");
        ...
        expect(object.args[4]).toBe("middle-center");
        expect(object.args[5]).toBe("top-left");
    });
});