...
import { execute as characterUpdateAlphaMultiplierCreateHistoryObjectService } from "../service/CharacterUpdateAlphaMultiplierCreateHistoryObjectService";
...
export const execute = async (
    ...
    // fixed logic
    const historyObject = characterUpdateAlphaMultiplierCreateHistoryObjectService(
    ...
    if (work_space.active) {
        historyAddElementUseCase(
            ...
            historyGetTextService($CHARACTER_UPDATE_ALPHA_MULTIPLIER_COMMAND),
            "",
            ...historyObject.args
        );
    }
