import { execute } from "./CharacterUpdateRotateCreateHistoryObjectService";
import { $CHARACTER_UPDATE_ROTATE_COMMAND } from "../../../../../../../config/HistoryConfig";
import { MovieClip } from "../../../../../../../core/domain/model/MovieClip";
import { Character } from "../../../../../../../core/domain/model/Character";
import { describe, expect, it } from "vitest";

describe("CharacterUpdateRotateCreateHistoryObjectService Test", () =>
{
    it("execute test", () =>
    {
        ...
        const object = execute(1, movieClip, layer, character, 120);
        expect(object.command).toBe($CHARACTER_UPDATE_ROTATE_COMMAND);
        ...
        expect(object.messages[5]).toBe(120);
        expect(object.messages[6]).toBe(character.rotation);
        ...
        expect(object.args[4]).toBe(120);
        expect(object.args[5]).toBe(character.rotation);
    });
});