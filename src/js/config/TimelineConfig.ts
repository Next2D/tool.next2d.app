 ...
 * @constant
 */
export const $TIMELINE_ID: string = "timeline";
 ...
 * @constant
 */
export const $TIMELINE_CONTAINER_MAIN_ID: string = "timeline-container-main";
...
/**
 * @description タイムラインのヘッダーの幅拡大ElementのID
 *              ID for Timeline Header Width Expansion Element
 *
 * @type {string}
 * @constant
 */
export const $TIMELINE_ADJUSTMENT_X_ID: string = "timeline-adjustment-x";

/**
 * @description タイムラインのヘッダーの高さ拡大ElementのID
 *              ID of Height Expansion Element in Timeline Header
 *
 * @type {string}
 * @constant
 */
