...
export const execute = (event: PointerEvent): void =>
{
    ...
    element.addEventListener(EventType.MOUSE_MOVE, timelineScrollXPointerMoveUseCase);
    element.addEventListener(EventType.MOUSE_UP, timelineScrollXPointerUpUseCase);
};