...
{
    window.addEventListener(EventType.MOUSE_MOVE, timelineHeaderIconWindowMoveEventUseCase);
    window.addEventListener(EventType.MOUSE_UP, timelineHeaderIconWindowUpEventUseCase);
};