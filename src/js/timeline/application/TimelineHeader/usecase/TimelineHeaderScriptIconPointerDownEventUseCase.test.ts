import { execute } from "./TimelineHeaderScriptIconPointerDownEventUseCase";
...
describe("TimelineHeaderScriptIconPointerDownEventUseCase Test", () =>
{
    it("execute test script", (): void =>
    {
        ...
        movieClip.setAction(frame, "test");
