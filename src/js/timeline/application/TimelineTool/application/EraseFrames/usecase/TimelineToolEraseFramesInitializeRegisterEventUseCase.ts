...
import { execute as timelineToolEraseFramesPointerDownEventUseCase } from "./TimelineToolEraseFramesPointerDownEventUseCase";
...
export const execute = (): void =>
{
    ...
    element.addEventListener(EventType.POINTER_DOWN,
        timelineToolEraseFramesPointerDownEventUseCase
    );
};