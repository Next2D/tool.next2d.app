...
import { execute } from "./ReferenceSettingUpdateXService";

describe("ReferenceSettingUpdateXService", () => {
    ...
    beforeEach(() => {
        ...
        mockInputElement.id = $TRANSFORM_REFERENCE_X_ID;
    ...
    describe("DOM操作の検証", () => {
        ...
        test("document.getElementByIdが正しい引数で呼ばれる", () => {
            ...
            expect(spy).toHaveBeenCalledWith($TRANSFORM_REFERENCE_X_ID);
        });
