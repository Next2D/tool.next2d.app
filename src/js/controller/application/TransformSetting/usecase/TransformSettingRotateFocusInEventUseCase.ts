...
/**
 * @description 変形エリアの回転のフォーカスイベント処理
 *              Focus event processing of the transformation area rotation
 *
...
export const execute = (event: FocusEvent): void =>
{
    ...
    transformSetting.rotation = transformSetting.beforeRotation = parseFloat(element.value);
