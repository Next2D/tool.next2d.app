import { execute } from "./TransformSettingWidthFocusInEventUseCase";
...
describe("TransformSettingWidthFocusInEventUseCase Test", () =>
{
    ...
    it("execute test case2", () =>
    {
        ...
        widthInput.id = $TRANSFORM_OBJECT_HEIGHT_ID;
        ...
        execute(mockEvent);
        expect(transformSetting.beforeWidth).toBe(100);
        expect(transformSetting.beforeHeight).toBe(200);
        expect(stopPropagation).toBe(true);
        expect($useKeyboard()).toBe(true);
