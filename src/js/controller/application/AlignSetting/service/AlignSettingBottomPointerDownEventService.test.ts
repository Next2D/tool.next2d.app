...
import { execute } from "./AlignSettingBottomPointerDownEventService";

describe("AlignSettingBottomPointerDownEventService", () => {
    ...
    beforeEach(() => {
        ...
        mockExternalAlignInstance = {
            bottom: vi.fn().mockResolvedValue(undefined)
        };
