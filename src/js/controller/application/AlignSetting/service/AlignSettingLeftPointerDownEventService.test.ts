...
import { execute } from "./AlignSettingLeftPointerDownEventService";

describe("AlignSettingLeftPointerDownEventService", () => {
    ...
    describe("非同期処理", () => {
        it("left メソッドが非同期で実行される", async () => {
            let leftCalled = false;
            mockExternalAlignInstance.left.mockImplementation(async () => {
