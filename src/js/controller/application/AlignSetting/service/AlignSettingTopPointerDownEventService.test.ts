...
import { execute } from "./AlignSettingTopPointerDownEventService";

describe("AlignSettingTopPointerDownEventService", () => {
    ...
    beforeEach(() => {
        ...
        mockExternalAlignInstance = {
            top: vi.fn().mockResolvedValue(undefined)
        };
    ...
    describe("非同期処理", () => {
        it("top メソッドが非同期で実行される", async () => {
            let topCalled = false;
            mockExternalAlignInstance.top.mockImplementation(async () => {
