...
import { execute } from "./AlignSettingStageLeftPointerDownEventService";

describe("AlignSettingStageLeftPointerDownEventService", () => {
    ...
    beforeEach(() => {
        ...
        mockExternalAlignInstance = {
            stageLeft: vi.fn().mockResolvedValue(undefined)
        };
