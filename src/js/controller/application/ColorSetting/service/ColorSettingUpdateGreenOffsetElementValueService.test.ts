...
import { execute } from "./ColorSettingUpdateGreenOffsetElementValueService";
import { $COLOR_GREEN_OFFSET_ID } from "@/config/ColorSettingConfig";

describe("ColorSettingUpdateGreenOffsetElementValueService", () =>
{
    ...
    beforeEach(() =>
    {
        ...
        mockElement.type = "number"; // GreenOffsetは負の値を許容するためnumber
        mockElement.id = $COLOR_GREEN_OFFSET_ID;
    ...
    describe("基本動作", () =>
    {
        it("要素が存在する場合、値が設定される", () =>
        {
            ...
            expect(document.getElementById).toHaveBeenCalledWith($COLOR_GREEN_OFFSET_ID);
        ...
        it("$COLOR_GREEN_OFFSET_IDを使用して要素を取得する", () =>
        {
            execute(50);
