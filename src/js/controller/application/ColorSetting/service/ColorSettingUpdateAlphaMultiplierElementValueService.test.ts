...
import { execute } from "./ColorSettingUpdateAlphaMultiplierElementValueService";
import { $COLOR_ALPHA_MULTIPLIER_ID } from "@/config/ColorSettingConfig";

describe("ColorSettingUpdateAlphaMultiplierElementValueService", () =>
{
    ...
    beforeEach(() =>
    {
        ...
        mockElement.id = $COLOR_ALPHA_MULTIPLIER_ID;
    ...
    describe("基本動作", () =>
    {
        it("要素が存在する場合、値が設定される", () =>
        {
            ...
            expect(document.getElementById).toHaveBeenCalledWith($COLOR_ALPHA_MULTIPLIER_ID);
        ...
        it("$COLOR_ALPHA_MULTIPLIER_IDを使用して要素を取得する", () =>
        {
            execute(50);
