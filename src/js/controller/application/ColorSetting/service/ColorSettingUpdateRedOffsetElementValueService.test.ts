...
import { execute } from "./ColorSettingUpdateRedOffsetElementValueService";
import { $COLOR_RED_OFFSET_ID } from "@/config/ColorSettingConfig";

describe("ColorSettingUpdateRedOffsetElementValueService", () =>
{
    ...
    beforeEach(() =>
    {
        ...
        mockElement.type = "number"; // RedOffsetは負の値を許容するためnumber
        mockElement.id = $COLOR_RED_OFFSET_ID;
    ...
    describe("基本動作", () =>
    {
        it("要素が存在する場合、値が設定される", () =>
        {
            ...
            expect(document.getElementById).toHaveBeenCalledWith($COLOR_RED_OFFSET_ID);
        ...
        it("$COLOR_RED_OFFSET_IDを使用して要素を取得する", () =>
        {
            execute(50);
