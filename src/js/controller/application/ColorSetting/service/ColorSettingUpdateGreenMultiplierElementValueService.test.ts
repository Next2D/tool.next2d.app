...
import { execute } from "./ColorSettingUpdateGreenMultiplierElementValueService";
import { $COLOR_GREEN_MULTIPLIER_ID } from "@/config/ColorSettingConfig";

describe("ColorSettingUpdateGreenMultiplierElementValueService", () =>
{
    ...
    beforeEach(() =>
    {
        ...
        mockElement.id = $COLOR_GREEN_MULTIPLIER_ID;
    ...
    describe("基本動作", () =>
    {
        it("要素が存在する場合、値が設定される", () =>
        {
            ...
            expect(document.getElementById).toHaveBeenCalledWith($COLOR_GREEN_MULTIPLIER_ID);
        ...
        it("$COLOR_GREEN_MULTIPLIER_IDを使用して要素を取得する", () =>
        {
            execute(50);
    ...
    describe("HTMLInputElementのキャスト", () =>
    {
        ...
        it("要素がHTMLInputElementでない場合でもエラーにならない", () =>
        {
            ...
            divElement.id = $COLOR_GREEN_MULTIPLIER_ID;
