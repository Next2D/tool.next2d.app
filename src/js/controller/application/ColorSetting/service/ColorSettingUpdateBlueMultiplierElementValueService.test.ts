...
import { execute } from "./ColorSettingUpdateBlueMultiplierElementValueService";
import { $COLOR_BLUE_MULTIPLIER_ID } from "@/config/ColorSettingConfig";

describe("ColorSettingUpdateBlueMultiplierElementValueService", () =>
{
    ...
    beforeEach(() =>
    {
        ...
        mockElement.id = $COLOR_BLUE_MULTIPLIER_ID;
    ...
    describe("基本動作", () =>
    {
        it("要素が存在する場合、値が設定される", () =>
        {
            ...
            expect(document.getElementById).toHaveBeenCalledWith($COLOR_BLUE_MULTIPLIER_ID);
        ...
        it("$COLOR_BLUE_MULTIPLIER_IDを使用して要素を取得する", () =>
        {
            execute(50);
    ...
    describe("HTMLInputElementのキャスト", () =>
    {
        ...
        it("要素がHTMLInputElementでない場合でもエラーにならない", () =>
        {
            ...
            divElement.id = $COLOR_BLUE_MULTIPLIER_ID;
