...
import { execute } from "./ColorSettingUpdateAlphaOffsetElementValueService";
import { $COLOR_ALPHA_OFFSET_ID } from "@/config/ColorSettingConfig";

describe("ColorSettingUpdateAlphaOffsetElementValueService", () =>
{
    ...
    beforeEach(() =>
    {
        ...
        mockElement.type = "number"; // AlphaOffsetは負の値を許容するためnumber
        mockElement.id = $COLOR_ALPHA_OFFSET_ID;
    ...
    describe("基本動作", () =>
    {
        it("要素が存在する場合、値が設定される", () =>
        {
            ...
            expect(document.getElementById).toHaveBeenCalledWith($COLOR_ALPHA_OFFSET_ID);
        ...
        it("$COLOR_ALPHA_OFFSET_IDを使用して要素を取得する", () =>
        {
            execute(50);
