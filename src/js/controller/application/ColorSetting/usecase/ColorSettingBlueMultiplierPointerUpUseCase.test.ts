...
const { execute } = await import("./ColorSettingBlueMultiplierPointerUpUseCase");

describe("ColorSettingBlueMultiplierPointerUpUseCase", () => {
    ...
    describe("基本動作", () => {
        ...
        it("targetがnullの場合でもstate変更は実行される", async () => {
