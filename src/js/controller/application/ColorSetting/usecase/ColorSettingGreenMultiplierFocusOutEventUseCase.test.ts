...
describe("ColorSettingGreenMultiplierFocusOutEventUseCase", () => {
    ...
    describe("基本動作", () => {
        ...
        it("colorSettingGreenMultiplierUpdateValueUseCaseが呼ばれる", async () => {
            ...
            expect(mockColorSettingGreenMultiplierUpdateValueUseCase).toHaveBeenCalledTimes(1);
        });
    });
    ...
    describe("値の解析とクランプ", () => {
        ...
        it("0の値が正しく処理される", async () => {
            ...
            expect(mockColorSettingGreenMultiplierUpdateValueUseCase).toHaveBeenCalledWith(0);
        });
        ...
        it("100の値が正しく処理される", async () => {
            ...
            expect(mockColorSettingGreenMultiplierUpdateValueUseCase).toHaveBeenCalledWith(100);
        });
    });
});
