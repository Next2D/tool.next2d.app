...
const mockColorSettingRedMultiplierPointerMoveUseCase = vi.fn();
const mockColorSettingRedMultiplierPointerUpUseCase = vi.fn();
...
vi.mock("./ColorSettingRedMultiplierPointerMoveUseCase", () => ({
    execute: mockColorSettingRedMultiplierPointerMoveUseCase
}));

vi.mock("./ColorSettingRedMultiplierPointerUpUseCase", () => ({
    execute: mockColorSettingRedMultiplierPointerUpUseCase
}));

const { execute } = await import("./ColorSettingRedMultiplierPointerDownUseCase");
...
describe("ColorSettingRedMultiplierPointerDownUseCase", () => {
