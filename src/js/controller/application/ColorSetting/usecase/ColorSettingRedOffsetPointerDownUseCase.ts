...
import { execute as colorSettingRedOffsetPointerUpUseCase } from "./ColorSettingRedOffsetPointerUpUseCase";
import {
    $activeTouchPointers,
    $setEditingElement
...
/**
 * @description カラー設定エリアの赤色オフセット変更のポインターダウンイベント
 *              Pointer down event for changing the red offset of the color setting area
 *
...
export const execute = (event: PointerEvent): void =>
{
    ...
    element.addEventListener(
        ...
        colorSettingRedOffsetPointerUpUseCase
    );
    element.addEventListener(
