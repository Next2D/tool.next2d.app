...
const mockColorSettingBlueMultiplierPointerMoveUseCase = vi.fn();
const mockColorSettingBlueMultiplierPointerUpUseCase = vi.fn();
...
vi.mock("./ColorSettingBlueMultiplierPointerMoveUseCase", () => ({
    execute: mockColorSettingBlueMultiplierPointerMoveUseCase
}));

vi.mock("./ColorSettingBlueMultiplierPointerUpUseCase", () => ({
    execute: mockColorSettingBlueMultiplierPointerUpUseCase
}));

const { execute } = await import("./ColorSettingBlueMultiplierPointerDownUseCase");
...
describe("ColorSettingBlueMultiplierPointerDownUseCase", () => {
