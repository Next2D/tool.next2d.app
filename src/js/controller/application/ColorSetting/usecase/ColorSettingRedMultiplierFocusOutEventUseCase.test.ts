...
describe("ColorSettingRedMultiplierFocusOutEventUseCase", () => {
    ...
    describe("基本動作", () => {
        ...
        it("colorSettingRedMultiplierUpdateValueUseCaseが呼ばれる", async () => {
            ...
            expect(mockColorSettingRedMultiplierUpdateValueUseCase).toHaveBeenCalledTimes(1);
        });
    });
    ...
    describe("値の解析とクランプ", () => {
        ...
        it("0の値が正しく処理される", async () => {
            ...
            expect(mockColorSettingRedMultiplierUpdateValueUseCase).toHaveBeenCalledWith(0);
        });
        ...
        it("100の値が正しく処理される", async () => {
            ...
            expect(mockColorSettingRedMultiplierUpdateValueUseCase).toHaveBeenCalledWith(100);
        });
    });
});
