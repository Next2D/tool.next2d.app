...
vi.mock("./ColorSettingGreenOffsetPointerUpUseCase", () => ({
    execute: vi.fn()
}));

const { execute } = await import("./ColorSettingGreenOffsetPointerDownUseCase");
...
describe("ColorSettingGreenOffsetPointerDownUseCase", () => {
