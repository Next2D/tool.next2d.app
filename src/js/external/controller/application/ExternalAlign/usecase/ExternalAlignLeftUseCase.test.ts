...
import { execute } from "./ExternalAlignLeftUseCase";

describe("ExternalAlignLeftUseCase", () => {
    ...
    describe("左端揃え処理", () => {
        it("選択範囲の左端に合わせて位置が調整される", async () => {
            ...
            // leftX = 50, dx = 50 + (100 - 80) = 70
            expect(mockExternalCharacterInstance.setX).toHaveBeenCalledWith(70);
        });
