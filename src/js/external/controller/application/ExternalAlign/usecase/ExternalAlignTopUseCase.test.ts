...
import { execute } from "./ExternalAlignTopUseCase";

describe("ExternalAlignTopUseCase", () => {
    ...
    describe("上端揃え処理", () => {
        it("選択範囲の上端に合わせて位置が調整される", async () => {
            ...
            // topY = 50, dy = 50 + (100 - 80) = 70
            expect(mockExternalCharacterInstance.setY).toHaveBeenCalledWith(70);
        });
