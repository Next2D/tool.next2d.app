...
import { execute } from "./ExternalAlignCenterUseCase";

describe("ExternalAlignCenterUseCase", () => {
    ...
    describe("中央揃え処理", () => {
        it("選択範囲の中央に合わせて位置が調整される", async () => {
            ...
            // centerX = (0 + 200) / 2 = 100, characterCenterX = (50 + 150) / 2 = 100
            // dx = 100 + (100 - 100) = 100
