 ...
 *              Keyboard event of DisplayObject, move to the left
 *
...
export const execute = (event: KeyboardEvent): void =>
{
    ...
    // 選択中のElementを左方向へ移動
    screenDisplayObjectSelectedMoveElementService(-x, 0);

    // プロパティーエリアの値を更新
    transformSettingUpdateXElementService(calcBounds.xMin - x);
